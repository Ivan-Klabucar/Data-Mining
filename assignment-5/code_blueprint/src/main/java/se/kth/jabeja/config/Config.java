...
public class Config {
  ...
  private Float alpha;
  private Boolean diffAnnealing;
  private Boolean rstAnnealing;
  private Double customAccFunc;

  public Config setCustomAccFunc(Double customAccFunc) {
    this.customAccFunc = customAccFunc;
    return this;
  }

  public Config setDiffAnnealing(Boolean diffAnnealing) {
    this.diffAnnealing = diffAnnealing;
    return this;
  }

  public Config setRstAnnealing(Boolean rstAnnealing) {
    this.rstAnnealing = rstAnnealing;
    return this;
  }
  ...
  public Boolean getDiffAnnealing() {
    if (this.diffAnnealing == null) {
      throw new NullPointerException("diffAnnealing is not set");
    }
    return this.diffAnnealing;
  }

  public Double getCustomAccFunc() {
    return this.customAccFunc;
  }

  public Boolean getRstAnnealing() {
    if (this.rstAnnealing == null) {
      throw new NullPointerException("rstAnnealing is not set");
    }
    return this.rstAnnealing;
  }
